...
- 详见 [docs/03-数据设计.md](docs/03-数据设计.md)
...
| 编号 | 文档 | 内容 |
|---|---|---|
| 01 | [需求文档](docs/01-需求文档.md) | 背景、方案对比、功能与非功能需求 |
| 02 | [技术方案](docs/02-技术方案.md) | 架构、选型、关键决策、构建部署 |
| 03 | [数据设计](docs/03-数据设计.md) | gallery.json schema、目录约定、一致性 |
| 04 | [ROADMAP](docs/04-ROADMAP.md) | 分期里程碑与验收标准 |
